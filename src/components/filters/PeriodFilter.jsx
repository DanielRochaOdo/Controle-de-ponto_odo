...
const PeriodFilter = ({ startDate, endDate, onApply }) => {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className="flex h-11 w-full items-center justify-between gap-3 rounded-xl border border-[#d7e5cf] bg-white px-3 text-left text-sm text-[#294436] outline-none transition hover:border-[#b8d7a5] focus:border-[#57D100] focus:ring-2 focus:ring-[#57D100]/15 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
        aria-expanded={open}
      >
      ...
      {open && (
        <div className="absolute left-0 top-[74px] z-50 w-[320px] max-w-[calc(100vw-2rem)] rounded-2xl border border-[#cfe0c5] bg-white p-4 shadow-[0_18px_45px_rgba(23,60,44,0.16)] dark:border-slate-700 dark:bg-slate-900">
